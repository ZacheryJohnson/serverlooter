...
tutorial_stage_12 =
    Here is where you can buy and sell algorithms that have been stolen from corps.
    Let's buy a Packet Spoofing algorithm, then click on the Scripts tab to add it.
tutorial_stage_13 =
